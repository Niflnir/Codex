      ...
      <div className="pt-12 pb-4 flex flex-col m-6 space-y-0 bg-white shadow-lg rounded-2xl w-2/5 min-w-[500px]">
        ...
        <div className="flex flex-col px-6 items-center">
          ...
          <form onSubmit={onSubmit} className="flex flex-col items-center">
            ...
            <button className="mt-16 rounded-3xl bg-white text-blue outline outline-1 outline-blue hover:bg-blue hover:text-white px-5 py-2 text-lg transition delay-50">Sign up</button>
          </form> 
