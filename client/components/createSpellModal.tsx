...
export default () => {
  ...
  const createSpellHandler = async () => {
    ...
    const response = await changeRequest("post", "api/spells", {
      title: title,
      body: body,
    ...
    >
      ...
      <div className="flex px-7 pt-1 flex-col space-y-2">
        ...
        <textarea
          ...
          className="w-[600px] py-1 px-2 outline outline-1 outline-gray-300 rounded-md focus:outline-saffron"
          rows={1}
          required
        />
      </div>
      <div className="flex px-7 flex-col space-y-2">
        ...
        <textarea
          ...
          className="py-1 px-2 box-border leading-normal outline outline-1 outline-gray-300 rounded-md focus:outline-saffron"
          rows={14}
          required
        />
      </div>
      <div className="flex justify-center">
        ...
        <div className="py-1 px-2 my-1">
          {files ? files.length : "No"} images chosen
        </div>
      </div>
      <input
        ref={uploadRef}
      ...
      <div className="flex justify-center pt-2">
        <button
          className="p-2 text-saffron border-[1px] outline-saffron border-saffron rounded-lg hover:bg-saffron hover:text-white transition hover:scale-125"
          type="submit"
