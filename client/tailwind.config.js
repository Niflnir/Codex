    ...
    extend: {
      ...
      keyframes: {
        ...
        xLogoBlue: {
          ...
          '80%': { transform: 'translate(107px, 81px) scale(0.45,0.45) rotate(10deg)'},
          '100%': { transform: 'translate(107px, 81px) scale(0.45,0.45) rotate(10deg)'},
        },
        xLogoSaffron: {
          '0%, 60%': { transform: 'translate(0px, 0px)'},
          '80%': { transform: 'translate(100px, 87px) scale(0.45,0.45) rotate(-10deg)'},
          '100%': { transform: 'translate(100px, 87px) scale(0.45,0.45) rotate(-10deg)'},
        },
        wiggle: {
